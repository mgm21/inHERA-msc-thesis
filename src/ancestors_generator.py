...
class AncestorsGenerator:
    def __init__(self, path_to_family, task, shortform_damage_list=None, ite_alpha=0.9, ite_num_iter=20, verbose=False,):
...
if __name__ == "__main__":
    ...
    from results.family_2 import family_task

    ancest_gen = AncestorsGenerator(path_to_family='results/family_2',
