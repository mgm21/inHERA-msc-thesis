...
class AlgorithmComparator:
    ...
    def get_algo_means_and_var(self):
        ...
        res_dict = children_loader.load_children(path_to_family=self.path_to_family,
                                      algos_to_extract=self.algorithms_to_test)
