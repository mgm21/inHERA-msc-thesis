...
for l1 in l1_regularisation_weight_list:
    for v in invmax_regularisation_weight_list:
            print(f"Starting pass for l1={l1} and v={v}")
            path_to_hyperparam_folder = f"{save_dir}/hyperparameter_sweep/l1_{l1}-v_{v}"
            ...
            children_generator.generate_custom_children(combinations=children_damage_combinations, l1_regularisation_weight=l1, invmax_regularisation_weight=v,) # Generate the chosen children
            children_generator.generate_custom_children(combinations=[()], l1_regularisation_weight=l1, invmax_regularisation_weight=v,) # Generate the intact child